...
class TechnicalSheetDetail(UpdateAPIView):
    queryset = TechnicalSheet.objects.all()
    serializer_class = TechnicalSheetSerializer
    ...
    def put(self, request, pk, format=None):
        return detail_response_put(request, pk, TechnicalSheet, TechnicalSheetSerializer)
